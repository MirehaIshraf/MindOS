...
from app.repositories.base import ChatRepository, ChatRunRepository, ConnectorSourceRepository, EventRepository, FileTaskRepository, PlaybookRepository, RelationshipRepository, TaskRepository
from app.repositories.memory_chat_repository import get_memory_chat_repository
from app.repositories.memory_chat_run_repository import get_memory_chat_run_repository
...
from app.repositories.sqlite_chat_run_repository import SQLiteChatRunRepository
...
_chat_run_repository: ChatRunRepository | None = None
...
def get_chat_run_repository() -> ChatRunRepository:
    global _chat_run_repository
    if _chat_run_repository is None:
        _chat_run_repository = SQLiteChatRunRepository() if use_sqlite() else get_memory_chat_run_repository()
    return _chat_run_repository
