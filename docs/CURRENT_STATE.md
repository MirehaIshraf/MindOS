...
- Attachment candidate search must stay bounded to recent task outputs, the current selected folder scan, or future explicit file index context. It must not silently full-scan the disk.
